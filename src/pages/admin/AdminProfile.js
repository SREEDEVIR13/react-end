...
<h1>Vehicles <button onClick={statusJoined}><Icons.FaEdit></Icons.FaEdit></button></h1>
                    ...
                    <div className='adminprofile-top'>
                                        ...
                                        {/* <div class="profile-bottom"><h4>Vehicles</h4></div> */}

                                               {/* <div class="profile-bottom">
                                        <div className='ap-outer-box'>
                                            <div className='ap-vehicle-details'>
                                            <div className='profile-bottom'>Toyota Matrix</div>
                                            <div className='ap-vehicle-name'>Hatchback  </div>
                                            <div className='ap-vehicle-name'> KL67J3848</div>
                                            <div className='ap-vehicle-name'> 4 seat</div>
                                            </div>
                                            <div className='ap-vehicle-details'>
                                            <img className='profile-img' src="https://cdn.pixabay.com/photo/2012/04/12/23/47/car-30984__340.png"alt="" /><br></br>
